...
from .general_parsers import rt_quadruplet_custom_formate, rt_quadruplet_custom_postprocess
...
class AgentReplThesisTripletTaskConfigSelector:
    ...
    def select(base_config_version: str = 'v1', cache_table_name: str = "mem_agent_replthesis_task_cache") -> AgentTaskSolverConfig:
        return AgentTaskSolverConfig(
            ...
            formate_context_func=rt_quadruplet_custom_formate, postprocess_answer_func=rt_quadruplet_custom_postprocess,
