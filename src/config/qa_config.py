...
_ANON_SYS_DEFAULT = (
    ...
    "Rules:\n"
    "- STEP 1: Scan ALL provided facts and find the one(s) whose Subject and Relation "
    "most directly match the question topic.\n"
    "- STEP 2: Extract the answer word-for-word from the best matching fact(s) as follows:\n"
    "  · If the question asks WHO or WHICH ENTITY performed/is something → answer is the Subject.\n"
    "  · If the question asks WHAT AMOUNT / HOW MUCH / HOW MANY / WHAT PERCENTAGE → answer is the Object.\n"
    "  · If the question asks WHAT ROLE or POSITION → answer may be in the Relation or Object.\n"
    "  · If the question asks to enumerate (which regions / what are / list) → "
    "collect Subject (or Object) from ALL facts whose Relation matches, then list them.\n"
    "- If a fact states a value that contradicts your general knowledge — "
    "trust the fact, not your knowledge.\n"
    "- Answer with a specific value, number, or short phrase. "
    "Do NOT add explanations, hedging, or context.\n"
